...
///**
// * MainController class for handling requests related to the home page and common navigation.
// */
//@Controller
...
//     * @return the name of the login page view template
//     */
//    @GetMapping("/login")
//    public String login() {
//        return "login";
...
//     * @return the name of the registration page view template
//     */
//    @GetMapping("/register")
...
//        {
//            Class.forName("com.mysql.jdbc.Driver");
//            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/cap_jetset","root","canthvaeit8");
//
...
/////ORIGINAL DRAFT ///////
  ...
  //      System.out.println("IN HomeController->root()");
...
//    public String admin(Model model) {
 ...
 //   public String login(Model model) {
  //      System.out.println("IN HomeController->login()");
  //      return "login";
 //   }

  //  @GetMapping("/account")
 //   public String userIndex() {
 //       System.out.println("IN HomeController->userIndex()");
 ...
 //   {
  //      System.out.println("IN HomeController->logoutResponse()");
 //       return "Logged out";
 //   }
// }
